...
export const WEAPONS = {
  ...
  smg: {
    ...
    dmg: 19, rpm: 850, auto: true, mag: 32, reload: 1.6,
    spread: 2.6, adsSpread: 1.0, recoil: 0.65, pellets: 1,
    aiRange: 13, adsFov: 62, sound: 'smg',
    desc: 'A hose of cheap brass. Wild past 15 meters, filthy up close.',
  },
  shotgun: {
    id: 'shotgun', name: 'PIT BOSS 12G', price: 950, tier: 2,
    dmg: 13, rpm: 78, auto: false, mag: 6, reload: 2.4,
    spread: 5.0, adsSpread: 3.5, recoil: 3.2, pellets: 8, falloff: 22,
    aiRange: 8, adsFov: 64, sound: 'shotgun',
    desc: '8 pellets of crowd-pleasing violence. Ends arguments inside 10m.',
  },
  rifle: {
    id: 'rifle', name: 'AK VULTURE', price: 1600, tier: 3,
    dmg: 38, rpm: 580, auto: true, mag: 30, reload: 1.9,
    spread: 1.8, adsSpread: 0.45, recoil: 1.5, pellets: 1,
